...
* @{
*/
#define PRODUCT_KEY "0d1902c2ebdc4d9fa3094d3bcf97767b"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "0581f345ecaf4efa913870c46d13c1ff"
...
#define Pressure_signal_RATIO                         0.1
#define Pressure_signal_ADDITION                      0
#define Pressure_signal_MIN                           3000
#define Pressure_signal_MAX                           13000
#define Pressure_signal_LEN                           2
#define Temperature_signal_RATIO                         0.1
#define Temperature_signal_ADDITION                      -250
#define Temperature_signal_MIN                           0
#define Temperature_signal_MAX                           20500
#define Temperature_signal_LEN                           2
#define Humidity_RATIO                         0.1
#define Humidity_ADDITION                      0
#define Humidity_MIN                           3000
#define Humidity_MAX                           13000
...
typedef struct {
  float valuePressure_signal[128];
  float valueTemperature_signal[8];
  float valueHumidity[8];
} dataPoint_t;

/** User Area Device State Structure */
typedef struct {
  uint8_t flagPressure_signal:1;
  uint8_t flagTemperature_signal:1;
...
typedef struct {
  uint16_t valuePressure_signal[128];
  uint16_t valueTemperature_signal[8];
  uint16_t valueHumidity[8];
} devStatus_t;
