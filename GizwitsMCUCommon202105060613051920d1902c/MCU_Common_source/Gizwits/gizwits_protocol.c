...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , uint8_t *outData,uint32_t *outDataLen)
{
    ...
    {
        devStatusTmp.valuePressure_signal = exchangeBytes(gizY2XFloat(Pressure_signal_RATIO,  Pressure_signal_ADDITION, dataPoints->valuePressure_signal));     
    ...
    {
        devStatusTmp.valueTemperature_signal = exchangeBytes(gizY2XFloat(Temperature_signal_RATIO,  Temperature_signal_ADDITION, dataPoints->valueTemperature_signal));     
    ...
    {
        devStatusTmp.valueHumidity = exchangeBytes(gizY2XFloat(Humidity_RATIO,  Humidity_ADDITION, dataPoints->valueHumidity));     
