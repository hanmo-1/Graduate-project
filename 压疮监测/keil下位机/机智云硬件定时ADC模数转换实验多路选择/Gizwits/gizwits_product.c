...
//{
// /*
//    currentDataPoint.valuePressure_signal = ;//Add Sensor Data Collection
//    currentDataPoint.valueTemperature_signal = ;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    /*
      currentDataPoint.valuePressure_signal = ;
      currentDataPoint.valueTemperature_signal = ;
